(function (global, factory) {
...
}(this, (function (exports, testing, angular, testing$1, core$1, core) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    function testingRootView() {
        var rootPageLayout = core.Frame.topmost().currentPage.content;
        var testingRoot;
        ...
        if (!testingRoot) {
            testingRoot = new core.GridLayout();
            testingRoot.id = TESTING_ROOT_ID;
            core.GridLayout.setColumnSpan(testingRoot, 100);
            core.GridLayout.setRowSpan(testingRoot, 100);
    ...
    var NativeScriptTestComponentRenderer = /** @class */ (function (_super) {
        ...
        NativeScriptTestComponentRenderer.prototype.insertRootElement = function (rootElId) {
            var layout = new core.ProxyViewContainer();
            layout.id = rootElId;
