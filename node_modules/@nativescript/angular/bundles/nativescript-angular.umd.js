(function (global, factory) {
...
}(this, (function (exports, core, zoneJs, common, nativescriptIntl, i0, compiler, i1, animations$1, browser, animations, http, rxjs, forms) { 'use strict';
    ...
    var NativeScriptDomAdapter = /** @class */ (function () {
        ...
        NativeScriptDomAdapter.makeCurrent = function () {
            ...
            common.ɵsetRootDomAdapter(new NativeScriptDomAdapter());
        };
    ...
    ***************************************************************************** */
    ...
    FrameService.ɵprov = i0.ɵɵdefineInjectable({ factory: function FrameService_Factory() { return new FrameService(); }, token: FrameService, providedIn: "root" });
    ...
    NSLocationStrategy.ɵprov = i0.ɵɵdefineInjectable({ factory: function NSLocationStrategy_Factory() { return new NSLocationStrategy(i0.ɵɵinject(FrameService)); }, token: NSLocationStrategy, providedIn: "root" });
    ...
    var ModalDialogService = /** @class */ (function () {
        function ModalDialogService(location, zone) {
    ...
    var TemplatedItemsComponent = /** @class */ (function () {
        function TemplatedItemsComponent(_elementRef, _iterableDiffers, zone) {
    ...
    var ListViewComponent = /** @class */ (function (_super) {
        ...
        function ListViewComponent(_elementRef, _iterableDiffers, zone) {
            return _super.call(this, _elementRef, _iterableDiffers, zone) || this;
        }
    ...
    var ɵ0$1 = function (parent, child, next) {
        if (isInvisibleNode(child)) {
            return;
        }
    ...
    var ɵ0$2 = replaceNgAttribute;
    var ɵ1$2 = function addScopedStyleToCss(style) {
        core.Application.addCss(style, true);
    };
    var addScopedStyleToCss = core.profile("\"renderer\".addScopedStyleToCss", ɵ1$2);
    ...
    var ɵ0$3 = function addStyleToCss(style) {
        core.Application.addCss(style);
    };
    var addStyleToCss = core.profile('"renderer".addStyleToCss', ɵ0$3);
    ...
    var ɵ0$4 = createKeyframeAnimationInfo;
    ...
    RouterExtensions.ɵprov = i0.ɵɵdefineInjectable({ factory: function RouterExtensions_Factory() { return new RouterExtensions(i0.ɵɵinject(i1.Router), i0.ɵɵinject(NSLocationStrategy), i0.ɵɵinject(FrameService)); }, token: RouterExtensions, providedIn: "root" });
        ...
        NSRouterLink.prototype.ngAfterViewInit = function () {
            ...
            this.el.nativeElement.on('tap', function () {
                _this.ngZone.run(function () {
                    if (exports.NativeScriptDebug.isLogEnabled()) {
                        exports.NativeScriptDebug.routerLog("nsRouterLink.tapped: " + _this.commands + " " + ("clear: " + _this.clearHistory + " ") + ("transition: " + JSON.stringify(_this.pageTransition) + " ") + ("duration: " + _this.pageTransitionDuration));
                    }
                    var extras = _this.getExtras();
                    // this.navigator.navigateByUrl(this.urlTree, extras);
                    _this.navigator.navigate(_this.commands, Object.assign(Object.assign({}, extras), { relativeTo: _this.route, queryParams: _this.queryParams, fragment: _this.fragment, preserveQueryParams: attrBoolValue(_this.preserveQueryParams), queryParamsHandling: _this.queryParamsHandling, preserveFragment: attrBoolValue(_this.preserveFragment) }));
                });
            });
        };
    ...
    exports.ɵa = InvisibleNode;
    exports.ɵb = NSFileSystem;
    exports.ɵc = ListViewComponent;
    exports.ɵd = TemplatedItemsComponent;
    exports.ɵe = TEMPLATED_ITEMS_COMPONENT;
    exports.ɵf = TemplateKeyDirective;
    exports.ɵg = TabViewDirective;
    exports.ɵh = TabViewItemDirective;
    exports.ɵi = ActionBarComponent;
    exports.ɵj = ActionBarScope;
    exports.ɵk = ActionItemDirective;
    exports.ɵl = NavigationButtonDirective;
    exports.ɵm = AndroidFilterComponent;
    exports.ɵn = IosFilterComponent;
    exports.ɵo = ModalDialogService;
    exports.ɵp = NSLocationStrategy;
    exports.ɵq = ViewUtil;
